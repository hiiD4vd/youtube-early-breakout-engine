...
export default function TopicTrendsPage() {
  ...
  return <div className="mx-auto max-w-7xl">
    ...
    <div className="mt-2 flex flex-wrap items-end justify-between gap-4"><div><h1 className="text-4xl font-bold">Trending topics</h1><p className="mt-2 max-w-2xl text-text-secondary">Pola yang muncul lintas video dan lintas channel—bukan daftar video viral satu per satu.</p></div><div className="rounded-lg border border-line bg-surface px-4 py-3 text-sm"><span className="font-mono text-neon">{data.items.length}</span> public clusters</div></div>
