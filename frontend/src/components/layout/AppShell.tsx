...
const groups = [{ label: "Intelligence", links: [{ href: "/youtube/trends", label: "Trending topics" }, { href: "/youtube", label: "Signal posts" }, { href: "/youtube/report", label: "24-hour report" }] }, { label: "Quality", links: [{ href: "/youtube/review", label: "Review queue" }] }, { label: "System", links: [{ href: "/youtube/demo", label: "Preview layout" }] }];
